...
${info.selectedDisabilities.map(d => `*${DISABILITY_PEDAGOGICAL_GUIDELINES[d]?.name || `HS khuyết tật ${d}`}: [Mục tiêu cụ thể đã giảm tải/điều chỉnh riêng cho dạng này]`).join('\n')}
  ...
  ${nlsFrameworkContext}
    ...
    - 🚨 CHỐNG IN ĐẬM TÙY TIỆN: Chỉ in đậm đúng tên tiêu đề/nhãn (ví dụ: **Bước 1: Chuyển giao nhiệm vụ:**, **HĐ1:**, **Kết luận:**, **Ví dụ 1:**, **Luyện tập 1:**, **Tranh luận:**). TUYỆT ĐỐI KHÔNG in đậm toàn bộ câu bài tập, lời giải hoặc các gạch đầu dòng của GV/HS.
